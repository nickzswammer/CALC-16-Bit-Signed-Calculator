...
VL_ATTR_COLD void Vgencon___024root___eval_static(Vgencon___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vgencon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vgencon___024root___eval_static\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
}

VL_ATTR_COLD void Vgencon___024root___eval_initial(Vgencon___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vgencon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vgencon___024root___eval_initial\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vgencon___024root___eval_final(Vgencon___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vgencon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vgencon___024root___eval_final\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
}
...
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vgencon___024root___eval_phase__stl(Vgencon___024root* vlSelf);

VL_ATTR_COLD void Vgencon___024root___eval_settle(Vgencon___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vgencon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vgencon___024root___eval_settle\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#endif
            VL_FATAL_MT("gencon.sv", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vgencon___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vgencon___024root___dump_triggers__stl(Vgencon___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vgencon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vgencon___024root___dump_triggers__stl\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((2ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 1 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[14].thingy____pinNumber2 or [hybrid] gencon.add_calc.complement.__Vcellout__a0____pinNumber1)\n");
    }
    if ((4ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 2 is active: @([hybrid] gencon.add_calc.complement.__Vcellout__a0____pinNumber1)\n");
    }
    if ((8ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 3 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[13].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[14].thingy____pinNumber4)\n");
    }
    if ((0x10ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 4 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[12].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[13].thingy____pinNumber4)\n");
    }
    if ((0x20ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 5 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[11].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[12].thingy____pinNumber4)\n");
    }
    if ((0x40ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 6 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[10].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[11].thingy____pinNumber4)\n");
    }
    if ((0x80ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 7 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[9].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[10].thingy____pinNumber4)\n");
    }
    if ((0x100ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 8 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[8].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[9].thingy____pinNumber4)\n");
    }
    if ((0x200ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 9 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[7].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[8].thingy____pinNumber4)\n");
    }
    if ((0x400ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 10 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[6].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[7].thingy____pinNumber4)\n");
    }
    if ((0x800ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 11 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[5].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[6].thingy____pinNumber4)\n");
    }
    if ((0x1000ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 12 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[4].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[5].thingy____pinNumber4)\n");
    }
    if ((0x2000ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 13 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[3].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[4].thingy____pinNumber4)\n");
    }
    if ((0x4000ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 14 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[2].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[3].thingy____pinNumber4)\n");
    }
    if ((0x8000ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 15 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[1].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[2].thingy____pinNumber4)\n");
    }
    if ((0x10000ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 16 is active: @([hybrid] gencon.add_calc.main.__Vcellout__a0____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[1].thingy____pinNumber4)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vgencon___024root___eval_stl(Vgencon___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vgencon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vgencon___024root___eval_stl\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
...
VL_ATTR_COLD bool Vgencon___024root___eval_phase__stl(Vgencon___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vgencon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vgencon___024root___eval_phase__stl\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vgencon___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelfRef.__VstlTriggered.any();
    if (__VstlExecute) {
        Vgencon___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vgencon___024root___dump_triggers__ico(Vgencon___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vgencon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vgencon___024root___dump_triggers__ico\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vgencon___024root___dump_triggers__act(Vgencon___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vgencon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vgencon___024root___dump_triggers__act\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[14].thingy____pinNumber2 or [hybrid] gencon.add_calc.complement.__Vcellout__a0____pinNumber1)\n");
    }
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([hybrid] gencon.add_calc.complement.__Vcellout__a0____pinNumber1)\n");
    }
    if ((4ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[13].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[14].thingy____pinNumber4)\n");
    }
    if ((8ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[12].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[13].thingy____pinNumber4)\n");
    }
    if ((0x10ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 4 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[11].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[12].thingy____pinNumber4)\n");
    }
    if ((0x20ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 5 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[10].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[11].thingy____pinNumber4)\n");
    }
    if ((0x40ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 6 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[9].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[10].thingy____pinNumber4)\n");
    }
    if ((0x80ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 7 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[8].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[9].thingy____pinNumber4)\n");
    }
    if ((0x100ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 8 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[7].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[8].thingy____pinNumber4)\n");
    }
    if ((0x200ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 9 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[6].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[7].thingy____pinNumber4)\n");
    }
    if ((0x400ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 10 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[5].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[6].thingy____pinNumber4)\n");
    }
    if ((0x800ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 11 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[4].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[5].thingy____pinNumber4)\n");
    }
    if ((0x1000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 12 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[3].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[4].thingy____pinNumber4)\n");
    }
    if ((0x2000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 13 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[2].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[3].thingy____pinNumber4)\n");
    }
    if ((0x4000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 14 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[1].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[2].thingy____pinNumber4)\n");
    }
    if ((0x8000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 15 is active: @([hybrid] gencon.add_calc.main.__Vcellout__a0____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[1].thingy____pinNumber4)\n");
    }
...
VL_ATTR_COLD void Vgencon___024root___dump_triggers__nba(Vgencon___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vgencon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vgencon___024root___dump_triggers__nba\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[14].thingy____pinNumber2 or [hybrid] gencon.add_calc.complement.__Vcellout__a0____pinNumber1)\n");
    }
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([hybrid] gencon.add_calc.complement.__Vcellout__a0____pinNumber1)\n");
    }
    if ((4ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[13].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[14].thingy____pinNumber4)\n");
    }
    if ((8ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[12].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[13].thingy____pinNumber4)\n");
    }
    if ((0x10ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 4 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[11].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[12].thingy____pinNumber4)\n");
    }
    if ((0x20ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 5 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[10].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[11].thingy____pinNumber4)\n");
    }
    if ((0x40ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 6 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[9].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[10].thingy____pinNumber4)\n");
    }
    if ((0x80ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 7 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[8].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[9].thingy____pinNumber4)\n");
    }
    if ((0x100ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 8 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[7].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[8].thingy____pinNumber4)\n");
    }
    if ((0x200ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 9 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[6].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[7].thingy____pinNumber4)\n");
    }
    if ((0x400ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 10 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[5].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[6].thingy____pinNumber4)\n");
    }
    if ((0x800ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 11 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[4].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[5].thingy____pinNumber4)\n");
    }
    if ((0x1000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 12 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[3].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[4].thingy____pinNumber4)\n");
    }
    if ((0x2000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 13 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[2].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[3].thingy____pinNumber4)\n");
    }
    if ((0x4000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 14 is active: @([hybrid] gencon.add_calc.main.__Vcellout__genblk1[1].thingy____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[2].thingy____pinNumber4)\n");
    }
    if ((0x8000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 15 is active: @([hybrid] gencon.add_calc.main.__Vcellout__a0____pinNumber2 or [hybrid] gencon.add_calc.main.__Vcellinp__genblk1[1].thingy____pinNumber4)\n");
    }
...
VL_ATTR_COLD void Vgencon___024root___ctor_var_reset(Vgencon___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vgencon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vgencon___024root___ctor_var_reset\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->clk = VL_RAND_RESET_I(1);
    vlSelf->reset = VL_RAND_RESET_I(1);
    vlSelf->keypad_input = VL_RAND_RESET_I(4);
    vlSelf->operator_input = VL_RAND_RESET_I(1);
    vlSelf->equal_input = VL_RAND_RESET_I(1);
    vlSelf->complete = VL_RAND_RESET_I(1);
    vlSelf->display_output = VL_RAND_RESET_I(16);
    vlSelf->ALU_in1 = VL_RAND_RESET_I(16);
    vlSelf->ALU_in2 = VL_RAND_RESET_I(16);
    vlSelf->start_calc = VL_RAND_RESET_I(1);
    vlSelf->ALU_out = VL_RAND_RESET_I(16);
    vlSelf->ALU_finish = VL_RAND_RESET_I(1);
    ...
    vlSelf->gencon__DOT__add_calc__DOT__n2 = VL_RAND_RESET_I(15);
    vlSelf->gencon__DOT__add_calc__DOT__diffSign = VL_RAND_RESET_I(1);
    vlSelf->gencon__DOT__add_calc__DOT