...
#ifndef VERILATED_VINPUT___024ROOT_H_
#define VERILATED_VINPUT___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vinput___024root final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vinput___024root(Vinput__Syms* symsp, const char* v__name);
    ~Vinput___024root();
    VL_UNCOPYABLE(Vinput___024root);
